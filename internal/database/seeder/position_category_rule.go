...
func (s PositionCategoryRuleSeeder) Run(db *gorm.DB) error {
	positionCategoryRules := []model.PositionCategoryRule{
		...
		{ID: 22, CategoryID: 3, PositionID: 10, NeedSignature: false, Description: "kak hmj", DisplayOrder: 9},
		{ID: 23, CategoryID: 3, PositionID: 11, NeedSignature: true, Description: "kak hmj", DisplayOrder: 10},
		...
		{ID: 27, CategoryID: 4, PositionID: 18, NeedSignature: true, Description: "kak hmps", DisplayOrder: 4},
		...
		{ID: 32, CategoryID: 4, PositionID: 10, NeedSignature: false, Description: "kak hmps", DisplayOrder: 10},
		{ID: 33, CategoryID: 4, PositionID: 11, NeedSignature: true, Description: "kak hmps", DisplayOrder: 11},
		...
		{ID: 41, CategoryID: 5, PositionID: 10, NeedSignature: false, Description: "kak ukm", DisplayOrder: 9},
		{ID: 42, CategoryID: 5, PositionID: 11, NeedSignature: true, Description: "kak ukm", DisplayOrder: 10},
		...
		{ID: 49, CategoryID: 6, PositionID: 10, NeedSignature: false, Description: "kak sbh", DisplayOrder: 8},
		{ID: 50, CategoryID: 6, PositionID: 11, NeedSignature: true, Description: "kak sbh", DisplayOrder: 9},
		...
		// Additional rules for KA. BAG. ADM. AKADEMIK DAN UMUM
		{ID: 89, CategoryID: 3, PositionID: 9, NeedSignature: false, Description: "kak hmj", DisplayOrder: 8},
		{ID: 90, CategoryID: 4, PositionID: 9, NeedSignature: false, Description: "kak hmps", DisplayOrder: 9},
		{ID: 91, CategoryID: 5, PositionID: 9, NeedSignature: false, Description: "kak ukm", DisplayOrder: 8},
		{ID: 92, CategoryID: 6, PositionID: 9, NeedSignature: false, Description: "kak sbh", DisplayOrder: 7},
	}
